...
public class UsuarioDaoImpl implements UsuarioDao {
	...
	public boolean insertar(Usuario u) {
		...
		String query = "insert into Usuarios (nombre_usuario_US, contrasena_US, codigo_tipo_usuario_US) " + "values('"
				+ u.getNombreUsuario() + "','" + u.getContrasenia() + "',2)";
		...
		try {
			...
			ResultSet rs = cn.query(
					"select * from bdbanco.usuarios U inner join bdbanco.tiposusuario TUS on TUS.codigo_tipo_usuario_TUS = U.codigo_tipo_usuario_US where nombre_usuario_US = '"
							+ Usuario + "' and contrasena_US = '" + clave + "'");
	...
	public boolean editar(Usuario usuario) {
		...
		String query = "update Usuarios set\r\n" + "nombre_usuario_US =" + usuario.getNombreUsuario() + ",\r\n"
				...
				+ usuario.getTipoUsuario().getCodTipoUsuario() + "',\r\n" + "where nombre_usuario_US ="
